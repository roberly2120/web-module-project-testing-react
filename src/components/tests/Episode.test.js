...
test("renders the summary test passed as prop", () => {
    ...
    const summary = screen.getByText(/this is a test statement/i)
...
test("renders default image when image is not defined", () => {
    render(<Episode episode={exampleEpisodeData3} />)
    const img = screen.getByRole('img');
    const imgAltText = screen.getByAltText('https://i.ibb.co/2FsfXqM/stranger-things.png');
...
const exampleEpisodeData2 = {
    ...
    season: 1,
    summary:
      "This is a test statement. Everyone has seen this show so why would you need a summary?",
    type: "regular",
    url: "https://www.tvmaze.com/episodes/553946/stranger-things-1x01-chapter-one-the-vanishing-of-will-byers",
  };
  const exampleEpisodeData3 = {
    airdate: "2016-07-15",
    airstamp: "2016-07-15T12:00:00+00:00",
    airtime: "",
    id: 553946,
